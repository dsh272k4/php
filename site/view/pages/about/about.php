                    ...
                    <div class="active-team-member section">
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <!-- <img src="assets/img/team/duongsh1.png" alt="Ảnh lỗi"> -->

                                </div>
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Nguyễn Văn Dương</a></h5>
                                    <p class="member-position">Leader</p>
                                    <p class="mb-20">Là người phụ trách quản lý công việc và phân chia các thành viên</p>
                                    <ul class="footer-social">
                                        <li>
                                            <a class="facebook" href="https://web.facebook.com/profile.php?id=100068114271008" title="Facebook"><i
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                ...
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#!">Vũ Đức Anh</a></h5>
                        ...
                        <div class="team-member-item">
                            <div class="team-member box-shadow">
                                <div class="team-member-photo">
                                    <img src="/site/assets/img/team/duongsh1.jpg" alt="">
                                </div>
                                <div class="team-member-info pt-20">
                                    <h5 class="member-name"><a href="#">Nguyễn Thành Quang</a></h5>
                                    <p class="member-position">Member</p>
